    ...
    >
      <VStack spacing="2px" w="100%">
        ...
        <HStack
          ...
          height="50px"
          cursor="pointer"
          background={selectedSection === "aprovados" ? "#DFFAFF" : ""}
          onClick={() => setSelectedSection("aprovados")}
        >
          <AiFillSafetyCertificate fontSize="1.3rem" />
          {isOpen && <Text>Aprovados</Text>}
        </HStack>
        <HStack
          justifyContent="center"
          w="100%"
          height="50px"
          cursor="pointer"
          background={selectedSection === "reprovadas" ? "#DFFAFF" : ""}
          onClick={() => setSelectedSection("reprovadas")}
        >
          <AiFillDelete fontSize="1.3rem" />
          {isOpen && <Text>Reprovados</Text>}
        </HStack>
      </VStack>
    </Box>
  );
